        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('dashboard.reviews.create') }}" class="btn btn-icon btn-info mr-1">@lang('site.create')
                ...
                <div class="card-block">
                    ...
                    @else
                        ...
                        <div class="text-center m-auto">{{ $reviews->appends(request()->query())->links() }}
                        </div>
                    @endif
