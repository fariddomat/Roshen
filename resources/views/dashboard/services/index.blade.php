        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('dashboard.services.create') }}" class="btn btn-icon btn-info mr-1">@lang('site.create')
                ...
                <div class="card-block">
                    ...
                    @else
                                ...
                                <tbody>
                                    @foreach ($services as $index => $service)
                                        <tr dir="rtl" style=" text-align: right;">
                                            ...
                                            <td dir="rtl">{{ $service->name }}</td>
                                            <td>{!! Str::limit($service->description, 190, ' ...') !!}
                                            </td>
                                            <td class="form-group">

                                                <a href="{{ route('dashboard.services.edit', $service->id) }}" type="button"
                        ...
                        <div class="text-center m-auto">{{ $services->appends(request()->query())->links() }}
                        </div>
                    @endif
