        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">الشروط والأحكام</h4>
                    <a href="{{ route('dashboard.terms.create') }}" class="btn btn-icon btn-info mr-1 mt-2" style="margin-top: 25px">@lang('site.create') <i
                                ...
                                <tbody>
                                    @foreach ($terms as $index => $term)
                                        <tr dir="rtl" style=" text-align: right;">
                                            ...
                                            <td dir="rtl">{!! Str::limit(strip_tags($term->content), 250 , ' ...') !!}</td>
                                            <td class="form-group">

                                                <a href="{{ route('dashboard.terms.edit', $term->id) }}" type="button"
