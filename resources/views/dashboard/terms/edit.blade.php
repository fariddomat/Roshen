                    ...
                    <div class="card-body" dir="rtl" style="text-align: right">
                        <div class="card-body col-lg-12">
                            <fieldset class="form-group">
                                <form action="{{ route('dashboard.terms.update', $term->id) }}" method="post"
                                   ...
                                   <h5 class="mt-2">التفاصيل</h5>
                                    <textarea name="content" class="form-control"  id="massage" rows="3" >{{old('content', $term->content)}}</textarea>
