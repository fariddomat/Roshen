        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">@lang('site.all_properties')</h4>
                ...
                <div class="card-block">
                            ...
                            <tbody>
                                @foreach ($properties as $index => $propertie)
                                    <tr dir="rtl" style=" text-align: right;">
                                        ...
                                        <td dir="rtl">{{ $propertie->name }}</td>
                                        <td>{{ $propertie->description }}</td>
                                        <td class="form-group">

                                            <a href="{{ route('dashboard.properties.edit', $propertie->id) }}" type="button"
                                                class="btn btn-icon btn-warning mr-1"
                                                style="  min-width: 100px;">@lang('site.edit') <i class="fa fa-edit"
                                                    style="position: relative;"></i></a>

                                            <form action="{{ route('dashboard.properties.destroy', $propertie->id) }}"
                    ...
                    <div class="text-center m-auto">{{ $properties->appends(request()->query())->links() }}
                    </div>
                    @endif
