        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">لماذا تختار روشم</h4>
                    <a href="{{ route('dashboard.whies.create') }}" class="btn btn-icon btn-info mr-1">@lang('site.create')
                                ...
                                <tbody>
                                    @foreach ($whies as $index => $why)
                                        <tr dir="rtl" style=" text-align: right;">
                                            ...
                                            <td dir="rtl">{{ $why->name }}</td>
                                            <td class="form-group">

                                                <a href="{{ route('dashboard.whies.edit', $why->id) }}" type="button"
                                                    class="btn btn-icon btn-warning mr-1"
                                                    style="  min-width: 100px;">@lang('site.edit') <i class="fa fa-edit"
                                                        style="position: relative;"></i></a>

                                                <form action="{{ route('dashboard.whies.destroy', $why->id) }}"
