                ...
                <div class="card-block">
                    <form action="{{ route('dashboard.blogs.update', $blog->id) }}" method="post"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="ar[title]" class="form-control"
                                value="{{ $blog->translate('ar')->title }}" dir="rtl">
                        </div>
                        {{-- <div class="form-group mb-3">
                    ...
                    <input type="text" name="en[title]" class="form-control"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="ar[introduction]" name="ar[introduction]" rows="5" dir="rtl">{{ $blog->translate('ar')->introduction }}</textarea>
                        </div>
                    ...
                    <textarea class="form-control" id="en[introduction]" name="en[introduction]"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="ar[content_table]" name="ar[content_table]" rows="5" dir="rtl">{{ $blog->translate('ar')->content_table }}</textarea>
                        </div>
                    ...
                    <textarea class="form-control" id="en[content_table]" name="en[content_table]"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="ar[first_paragraph]" name="ar[first_paragraph]" rows="5" dir="rtl">{{ $blog->translate('ar')->first_paragraph }}</textarea>
                        </div>
                    ...
                    <textarea class="form-control" id="en[first_paragraph]" name="en[first_paragraph]"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="ar[description]" name="ar[description]" rows="5" dir="rtl">{{ $blog->translate('ar')->description }}</textarea>
                        </div>
                    ...
                    <textarea class="form-control" id="en[description]" name="en[description]"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="ar[author_name]" class="form-control"
                                value="{{ $blog->translate('ar')->author_name }}" dir="rtl">
                        </div>
                        {{-- <div class="form-group mb-3">
                    ...
                    <input type="text" name="en[author_name]" class="form-control"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="ar[author_title]" class="form-control"
                                value="{{ $blog->translate('ar')->author_title }}" dir="rtl">
                        </div>
                        {{-- <div class="form-group mb-3">
