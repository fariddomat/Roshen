        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('dashboard.partners.create') }}" class="btn btn-icon btn-info mr-1">@lang('site.create')
                                ...
                                <tbody>
                                    @foreach ($partners as $index => $partner)
                                        <tr dir="rtl" style=" text-align: right;">
                                            ...
                                            <td dir="rtl"><img src="{{ asset($partner->img) }}" class="avatar" alt=""></td>
                                            <td class="form-group">

                                                <a href="{{ route('dashboard.partners.edit', $partner->id) }}" type="button"
