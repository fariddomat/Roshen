                ...
                <div class="card-block" dir="rtl" style="text-align: right">
                    <div class="col-lg-6">
                        <fieldset class="form-group">
                            <form action="{{ route('dashboard.facils.update', $facil->id) }}" method="post"
                                ...
                                <input value="{{ old('name', $facil->name) }}" name="name" type="text"
                                    class="form-control" id="basicInput" required>
                                    <h5 class="mt-2">icon</h5>
                                    <input value="{{ old('icon', $facil->icon) }}" name="icon" type="file" class="form-control"
                                        id="basicInput" required>
                                    <h5 class="mt-2">القيمة</h5>
                                    <input value="{{ old('value', $facil->value) }}" name="value" type="text" class="form-control"
                                        id="basicInput" required>
